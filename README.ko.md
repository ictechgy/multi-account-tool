...
| Goose | 기존 Keychain/Secret Service + YAML과 `~/.config/goose/` **직하**의 고정 파일 5개/제한 디렉터리 2개 | 프로필 swap 전용; v1.43 고정 경로만, discovery/session 격리 없음. **0.8.1 이전에 캡처한 프로필은 재스냅샷 필요** |
