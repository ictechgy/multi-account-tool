...
- **mat 추상화 추가 확장 필요 (보류)** — PR #30 quad-review 에서 wrong-account 위험 합의:
  ...
  - **추가 후속 업데이트**: backend custody selection/proof contract 완료. 다음 code PR 은 Linux Secret Service backend spike, 그 다음 public env-secret schema/runtime hard-stop PR 순서로 진행한다.
