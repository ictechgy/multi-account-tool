...
#   3. 이 파일을 `homebrew-mat` tap 저장소 (https://github.com/YOUR-USERNAME/homebrew-mat)
#      의 Formula/mat.rb 로 복사/푸시한다.
#   4. 사용자는 `brew tap YOUR-USERNAME/mat && brew install mat` 로 설치한다.
#
# 자세한 안내는 저장소 PUBLISHING.md 참고.

class Mat < Formula
  desc "여러 AI CLI(Claude Code, Codex, Gemini/Antigravity) 계정을 하나의 TUI에서 전환"
  homepage "https://github.com/YOUR-USERNAME/multi-subscription-terminal"
